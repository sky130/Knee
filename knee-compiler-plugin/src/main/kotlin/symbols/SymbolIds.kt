...
object RuntimeIds {
    ...
    val kneeGlobalize =                         CallableId(PackageNames.runtimeCompiler, Name.identifier("kneeGlobalize"))
    val kneeImportedCollectFlow =                CallableId(PackageNames.runtimeCompiler, Name.identifier("kneeImportedCollectFlow"))
    val kneeImportedCollectSharedFlow =          CallableId(PackageNames.runtimeCompiler, Name.identifier("kneeImportedCollectSharedFlow"))
    val kneeImportedEmitFlowCollector =          CallableId(PackageNames.runtimeCompiler, Name.identifier("kneeImportedEmitFlowCollector"))
